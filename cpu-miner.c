 ...
 * Copyright 2019 BeeHIve Network
 *
...
static void show_credits()
{
   ...
   printf("     BTC donation address: 3Qxyq3QDfaU2t8h4rDTTPTHgTdQc5bCJXd\n\n");
   printf("     LTC donation address: MEn4ZtshPVodC6dGeTgSQGS3oggzwaL1he\n\n");
   printf("     LIBT donation address: LaevVNpe1pfEYwsurRjhKzyXqZYDmxQhRG\n\n");
   printf("\n");
   printf("\n");
   printf("\n "PACKAGE_NAME" "PACKAGE_VERSION" \n");
   printf(" BeeHIVE Fork\n");
   printf(" https://github.com/Beehivenetwork \n");
   printf("\n");
}
